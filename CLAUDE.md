...
| [gologin.md](documentation/gologin.md) | **GoLogin** — the browser-profile satellite window, the `IGoLoginClient` adapter, and the rate limit that shapes it (a 429 revokes the API token permanently) |
