...
- **Step one writes nothing.** It collects account / date+time / caption / post link, validates the link (below), and hands a `PostDraft` up to the page. Its primary button is **Next**, not Schedule.
