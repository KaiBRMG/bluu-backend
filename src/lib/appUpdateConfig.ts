...
export const APP_UPDATE: AppUpdateConfig = {
  ...
  mac: { latestVersion: '0.14.0', compulsory: false, allUsers: false, uids: ['VoRCp0wmgvSgKG8yzxOyMyZ4cSv1'], groups: [] },
  // mac: null,

  // win: null,
  win: { latestVersion: '0.14.0', compulsory: false, allUsers: false, uids: [], groups: [] },
