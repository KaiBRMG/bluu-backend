...
export const APP_UPDATE: AppUpdateConfig = {
  ...
  mac: { latestVersion: '0.13.0', compulsory: false, allUsers: false, uids: [], groups: ['admin'] },
  // mac: null,

  // win: null,
  win: { latestVersion: '0.13.0', compulsory: false, allUsers: true, uids: ['qKiuhTreQDU6GAw8h5UuIr50eNp1'], groups: ['admin'] },
